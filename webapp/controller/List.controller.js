sap.ui.define(
  ...
  function (Controller, Filter, FilterOperator, MessageToast) {
    ...
    var STATUS_TEXT = {
      "01": "Version in Arbeit",
      "02": "Aktiv",
      "03": "In Freigabe",
      "04": "Freigabe teilweise",
      "05": "Freigabe abgeschlossen",
      "08": "Abgelehnt",
      11: "In Verteilung",
      12: "Fehler bei Verteilung",
      13: "Verteilt",
      14: "In Vorbereitung",
    ...
    return Controller.extend("purchaseorders.controller.List", {
      ...
      onTableUpdateFinished: function (oEvent) {
        ...
        this.byId("txtFilterCount").setText(
          iActual + " von " + iTotal + " Bestellungen",
        );
      },
      ...
      _applyFilters: function () {
        ...
        if (sCompany) {
          aFilters.push(new Filter("CompanyCode", FilterOperator.EQ, sCompany));
        }
      ...
      onExportPress: function () {
        ...
        var sCSV =
          "Bestellnummer,Lieferant,Status,Einkaufsorg.,Buchungskreis,Währung,Gesamtbetrag\n";
        aItems.forEach(function (oItem) {
          ...
          sCSV +=
            [
              ...
              STATUS_TEXT[o.getProperty("PurchasingProcessingStatus")] ||
                o.getProperty("PurchasingProcessingStatus"),
        ...
        oLink.href = URL.createObjectURL(
          new Blob([sCSV], { type: "text/csv;charset=utf-8;" }),
        );
